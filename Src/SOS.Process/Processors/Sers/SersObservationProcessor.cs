...
namespace SOS.Process.Processors.Sers
{
        ...
        ISersObservationProcessor
    {
        ...
        private async Task<int> ProcessBatchAsync(
            ...
            int endId,
            JobRunModes mode,
            SersObservationFactory observationFactory,
            ...
            IJobCancellationToken cancellationToken)
        {
            try
            {
                ...
                var verbatimObservationsBatch = await _sersObservationVerbatimRepository.GetBatchAsync(startId, endId);
            ...
            IJobCancellationToken cancellationToken)
        {
            ...
            var minId = 1;
            var maxId = await _sersObservationVerbatimRepository.GetMaxIdAsync();
