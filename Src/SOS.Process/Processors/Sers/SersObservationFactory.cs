...
namespace SOS.Process.Processors.Sers
{
    public class SersObservationFactory : ObservationfactoryBase, IObservationFactory<SersObservationVerbatim>
    {
        ...
        public SersObservationFactory(DataProvider dataProvider, IDictionary<int, Lib.Models.Processed.Observation.Taxon> taxa, IAreaHelper areaHelper, IGeometryManager geometryManager) : base(geometryManager)
        {
        ...
        /// <returns></returns>
        public async Task<Observation> CreateProcessedObservationAsync(SersObservationVerbatim verbatim)
        {
