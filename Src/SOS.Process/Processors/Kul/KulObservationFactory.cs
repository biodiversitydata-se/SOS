...
namespace SOS.Process.Processors.Kul
{
    public class KulObservationFactory : ObservationFactoryBase, IObservationFactory<KulObservationVerbatim>
    {
        ...
        public KulObservationFactory(DataProvider dataProvider, IDictionary<int, Lib.Models.Processed.Observation.Taxon> taxa, IAreaHelper areaHelper) : base(taxa)
        {
        ...
        /// <returns></returns>
        public Observation CreateProcessedObservation(KulObservationVerbatim verbatim, bool diffuseIfSupported)
        {
