...
{
    public class FishDataObservationFactory
    {
        private const int DefaultCoordinateUncertaintyInMeters = 500;
        private readonly DataProvider _dataProvider;
        private readonly IDictionary<int, ProcessedTaxon> _taxa;

        public FishDataObservationFactory(DataProvider dataProvider, IDictionary<int, ProcessedTaxon> taxa)
        {
        ...
        /// <returns></returns>
        public ProcessedObservation CreateProcessedObservation(FishDataObservationVerbatim verbatim)
        {
