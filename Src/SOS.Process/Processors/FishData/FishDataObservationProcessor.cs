...
namespace SOS.Process.Processors.FishData
{
    ...
    public class FishDataObservationProcessor : ObservationProcessorBase<FishDataObservationProcessor>, IFishDataObservationProcessor
    {
        ...
        private async Task<int> ProcessBatchAsync(
            ...
            int endId,
            JobRunModes mode,
            FishDataObservationFactory observationFactory,
            ...
            IJobCancellationToken cancellationToken)
        {
            try
            {
                ...
                var verbatimObservationsBatch = await _fishDataObservationVerbatimRepository.GetBatchAsync(startId, endId);
            ...
            IJobCancellationToken cancellationToken)
        {
            ...
            var minId = 1;
            var maxId = await _fishDataObservationVerbatimRepository.GetMaxIdAsync();
