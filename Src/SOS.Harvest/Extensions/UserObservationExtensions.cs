...
public static class UserObservationExtensions
{
    extension(Observation observation)
    {
        ...
        /// <returns></returns>
        private UserObservation ToUserObservation(UserInternal recordedBy)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<UserObservation> ToUserObservations()
        {
    ...
    extension(IEnumerable<Observation> observations)
    {
        /// <summary>
        ///  Create user observations
        /// </summary>
