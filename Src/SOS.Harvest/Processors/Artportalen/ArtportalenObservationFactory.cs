...
public class ArtportalenObservationFactory : ObservationFactoryBase, IObservationFactory<ArtportalenObservationVerbatim>
{
    ...
    public Observation CreateProcessedObservation(ArtportalenObservationVerbatim verbatimObservation, bool diffuseIfSupported)
    {
        try
        {
            ...
            GetStartEndDate(verbatimObservation.StartDate,
            ...
            obs.Event.SamplingProtocol = GetSamplingProtocol(verbatimObservation).Clean();
            ...
            obs.Identification.IdentifiedBy = verbatimObservation.DeterminedBy.Clean();
            ...
            if (verbatimObservation.Site != null)
            {
                ...
                obs.Location.Atlas10x10 = CastToArea(site.Atlas10x10!);
            ...
            obs.Location.VerbatimLocality = obs.Location.Locality.Clean();
