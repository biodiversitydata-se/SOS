...
namespace SOS.Harvest.Processors.Artportalen
{
    ...
    /// </summary>
    public class ArtportalenEventProcessor : ChecklistProcessorBase<ArtportalenChecklistProcessor, ArtportalenChecklistVerbatim, IVerbatimRepositoryBase<ArtportalenChecklistVerbatim, int>>,
        IArtportalenChecklistProcessor, IArtportalenEventProcessor
    {
        ...
        public ArtportalenEventProcessor(IVerbatimRepositoryBase<ArtportalenChecklistVerbatim, int> artportalenVerbatimRepository,
