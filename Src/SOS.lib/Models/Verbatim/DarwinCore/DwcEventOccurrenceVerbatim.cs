...
namespace SOS.Lib.Models.Verbatim.DarwinCore
{
    ...
    /// </summary>
    public class DwcEventOccurrenceVerbatim : IEntity<int>
    {
        /// <summary>
        ...
        /// </summary>
        public ICollection<DwcAudubonMedia> AudubonMedia { get; set; }

        /// <summary>
        ///     Multimedia linked to the event
        /// </summary>
        public ICollection<DwcMultimedia> Multimedia { get; set; }
