...
public static class ElasticSearchRequestExtensions
{
    ...
    extension(IDictionary<string, object>? bodyDictionary)
    {
        /// <summary>
        /// Remove some fields from search response
        /// </summary>
        /// <param name="bodyDictionary"></param>
        public void UpdateExclude(IEnumerable<string> excludeFields)
        {
        ...
        /// </summary>
        /// <param name="bodyDictionary"></param>
        public void UpdateQuery(IEnumerable<int> defaultProviderIds)
        {
