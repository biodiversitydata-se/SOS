namespace SOS.UserStatistics.Api.Tests.Tests.AutomaticIntegrationTests;
...
public class PagedSpeciesCountAggregationTests
{
    ...
    public PagedSpeciesCountAggregationTests(UserStatisticsAutomaticIntegrationTestFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact]
    public async Task Test_PagedSpeciesCountSearchAsync_sort_by_specific_area()
    {
        // Arrange
        var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(36)
            .All()
        ...
        // Act
        var res = await _fixture.UserStatisticsManager.PagedSpeciesCountSearchAsync(
    ...
    [Fact]
    public async Task Test_PagedSpeciesCountSearchAsync_filter_by_specific_area()
    {
        // Arrange
        var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(36)
            .All()
    ...
    public async Task Test_PagedSpeciesCountSearchAsync_with_large_amount_of_data()
    {
        // Arrange
