...
namespace SOS.Observations.Api.Controllers.Interfaces
{
    ...
    public interface IObservationController
    {
        ...
        /// <param name="nameFilter">Filter used to limit number of areas returned</param>
        /// <param name="skip">Start index of returned areas</param>
        /// <param name="take">End index of returned areas</param>
        /// <returns>List of Areas</returns>
        Task<IActionResult> GetAreasAsync(AreaType areaType, string nameFilter, int skip = 0, int take = 100);
    }
}
