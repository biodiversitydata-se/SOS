...
namespace SOS.Observations.Api.Dtos.DataStewardship
{
    ...
    public class DatasetDto
    {
        ...
        public OrganisationDto Assigner { get; set; }
        ...
        public IEnumerable<OrganisationDto> Creator { get; set; }
        ...
        public OrganisationDto OwnerinstitutionCode { get; set; }
        ...
        public OrganisationDto Publisher { get; set; }
        ...
        public IEnumerable<MethodologyDto> Methodology { get; set; }
