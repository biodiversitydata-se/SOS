...
namespace SOS.Observations.Api.Dtos.DataStewardship
{
    ...
    public class EventDto
    {
        ...
        public LocationDto SurveyLocation { get; set; }
        ...
        public IEnumerable<OrganisationDto> RecorderOrganisation { get; set; }
        ...
        public WeatherVariableDto Weather { get; set; }
        ...
        public IEnumerable<AssociatedMediaDto> AssociatedMedia { get; set; }
