...
{
    public static class DwcEventVerbatimFactory
    {
        public static DwcEventVerbatim Create(int id, IRow row, IIdIdentifierTuple idIdentifierTuple, int idIndex)
        {
            var verbatimRecord = new DwcEventVerbatim { Id = id };
