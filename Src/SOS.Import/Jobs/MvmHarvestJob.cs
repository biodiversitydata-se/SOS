...
namespace SOS.Import.Jobs
{
    public class MvmHarvestJob : IMvmHarvestJob
    {
        ...
        public async Task<bool> RunAsync(IJobCancellationToken  cancellationToken)
        {
            ...
            var dataProvider = await _dataProviderManager.GetDataProviderByType(DataSet.MvmObservations);
            ...
            return harvestInfoResult.Status.Equals(RunStatus.Success) && harvestInfoResult.Count > 0 ? true : throw new Exception("MVM Harvest Job failed");
        }
    }
}