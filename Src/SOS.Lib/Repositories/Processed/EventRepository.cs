            ...
            var createIndexResponse = await Client.Indices.CreateAsync(IndexName, s => s
                ...
                .Map<Event>(m => m
                    ...
                    .Properties(ps => ps
                        ...
                        .KeyWordLowerCase(kwlc => kwlc.EventType, index: false, docValues: false)
                        ...
                        .KeyWordLowerCase(kwlc => kwlc.PlainStartDate, index: true, docValues: false)
                        .KeyWordLowerCase(kwlc => kwlc.PlainStartTime, index: false, docValues: false)
                        .KeyWordLowerCase(kwlc => kwlc.PlainEndDate, index: true, docValues: false)
