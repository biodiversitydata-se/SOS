...
{
    extension(DwcMeasurementOrFact dwcMeasurementOrFact)
    {
        public ExtendedMeasurementOrFact ToProcessedExtendedMeasurementOrFact()
        {
    ...
    extension(DwcExtendedMeasurementOrFact dwcEmof)
    {
        public ExtendedMeasurementOrFact ToProcessedExtendedMeasurementOrFact()
        {
            return new ExtendedMeasurementOrFact()
    ...
    extension(IEnumerable<Observation> processedObservations)
    {
        public IEnumerable<SimpleMultimediaRow> ToSimpleMultimediaRows()
        {
            return processedObservations?.SelectMany(ToSimpleMultimediaRows) ?? Enumerable.Empty<SimpleMultimediaRow>();
        }

        public IEnumerable<SimpleMultimediaRow> ToArtportalenSimpleMultimediaRows()
        {
            return processedObservations?.SelectMany(ToArtportalenSimpleMultimediaRows) ?? Enumerable.Empty<SimpleMultimediaRow>();
        }

        public IEnumerable<ExtendedMeasurementOrFactRow> ToExtendedMeasurementOrFactRows(bool eventCore = false)
        {
    ...
    {
        private SimpleMultimediaRow ToSimpleMultimediaRow(
string eventId, string occurrenceId, bool emptyIdentifier, bool useTextHtmlFormat)
        {
    ...
    {
        public IEnumerable<ExtendedMeasurementOrFactRow> ToExtendedMeasurementOrFactRows(string occurrenceId)
        {
    ...
    extension(ExtendedMeasurementOrFact processedEmof)
    {
        private ExtendedMeasurementOrFactRow ToExtendedMeasurementOrFactRow(
string occurrenceId, string eventId = null)
        {
