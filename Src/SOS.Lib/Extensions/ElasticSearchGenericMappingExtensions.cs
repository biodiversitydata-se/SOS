...
internal static class ElasticSearchGenericMappingExtensions
{
    ...
    extension<T>(PropertiesDescriptor<T> propertiesDescriptor) where T : class
    {
        /// <summary>
        ...
        /// <param name="indexSetting"></param>
        /// <returns></returns>
        public PropertiesDescriptor<T> BooleanVal<TValue>(Expression<Func<T, TValue>> propertyName,
        ...
        /// <param name="indexSetting"></param>
        /// <returns></returns>
        public PropertiesDescriptor<T> DateVal<TValue>(Expression<Func<T, TValue>> propertyName,
            IndexSetting indexSetting = IndexSetting.SearchSortAggregate)
        {
            var indexSettings = GetIndexSettings(indexSetting);
            return propertiesDescriptor
        ...
        /// <returns></returns>
        public PropertiesDescriptor<T> KeywordVal<TValue>(Expression<Func<T, TValue>> propertyName,
            IndexSetting indexSetting = IndexSetting.SearchSortAggregate,
        ...
        /// <returns></returns>
        public PropertiesDescriptor<T> NumberVal<TValue>(Expression<Func<T, TValue>> propertyName,
        ...
        /// <param name="ignoreAbove"></param>
        /// <returns></returns>
        public PropertiesDescriptor<T> TextVal<TValue>(Expression<Func<T, TValue>> propertyName,
            bool index = true,
            int? ignoreAbove = null)
        {
            return propertiesDescriptor
