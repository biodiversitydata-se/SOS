...
public static class ProcessedExtensions
{
    extension(Event source)
    {
        ...
        public DarwinCoreEvent ToDarwinCore()
        {
            if (source == null)
            {
                return null;
    ...
    extension(Identification source)
    {
        #endregion Event

        #region Identification

        public DarwinCoreIdentification ToDarwinCore()
        {
            if (source == null)
            {
                return null;
    ...
    extension(Location source)
    {
        #endregion Identification

        #region Location

        public DarwinCoreLocation ToDarwinCore()
        {
            if (source == null)
            {
                return null;
    ...
    extension(Occurrence source)
    {
        #endregion Location

        #region Occurrence

        public DarwinCoreOccurrence ToDarwinCore()
        {
            if (source == null)
            {
                return null;
    ...
    extension(Taxon taxon)
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsBird() => taxon?.Attributes?.OrganismGroup?.ToLower() == "fåglar";
    }

    extension(Observation processedObservation)
    {
        #endregion Taxon
        ...
        /// <returns></returns>
        public DarwinCore ToDarwinCore(bool fixSbdiArtportalenDwcObservation = false)
        {
    ...
    extension(IEnumerable<Observation> processedObservations)
    {
        ...
        /// <param name="fixSbdiArtportalenDwcObservation"></param>
        /// <returns></returns>
        public IEnumerable<DarwinCore> ToDarwinCore(bool fixSbdiArtportalenDwcObservation = false)
        {
