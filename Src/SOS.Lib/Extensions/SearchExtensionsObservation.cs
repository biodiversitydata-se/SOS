...
public static class SearchExtensionsObservation
{
    ...
    {
        private void AddAuthorizationFilters(ExtendedAuthorizationFilter filter)
        {
        ...
        /// <returns></returns>
        private IEnumerable<int> TryAddInternalFilters(SearchFilterBase filter)
        {
        ...
        private void TryAddDataStewardshipFilter(DataStewardshipFilter filter)
        {
            if (filter != null)
            {
        ...
        /// </summary>
        /// <param name="filter"></param>
        private void TryAddDeterminationFilters(SearchFilterBase filter)
        {
        ...
        private void TryAddEventFilter(EventFilter filter)
        {
            if (filter != null)
            {
        ...
        private void TryAddModifiedDateFilter(ModifiedDateFilter filter)
        {
            if (filter != null)
            {
        ...
        private void TryAddGeographicalAreaFilter(
        ...
        private void TryAddLocationFilter(
    ...
    TaxonFilter filter)
        ...
        private void TryAddValidationStatusFilter(SearchFilterBase filter)
        {
            if (filter != null)
            {
        ...
        /// <returns></returns>
        public void AddAggregationFilter(AggregationType aggregationType)
        {
        ...
        public void AddSightingTypeFilters(SearchFilterBase.SightingTypeFilter sightingTypeFilter,
            IEnumerable<int> sightingTypeSearchGroupIds)
        {
    ...
    extension<TQueryDescriptor>(ICollection<Action<QueryDescriptor<TQueryDescriptor>>> excludeQueries) where TQueryDescriptor : class
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="filter"></param>
        /// <returns></returns>
        private void TryAddInternalExcludeFilters(SearchFilterBase filter)
        {
            if (filter is SearchFilterInternal internalFilter)
            {
    ...
    extension(IEnumerable<string> includes)
    {
        /// <summary>
        ...
        /// <returns></returns>
        public SourceConfig ToProjection(
            bool isInternal)
        {
    ...
    extension((IEnumerable<string> Includes, IEnumerable<string> Excludes) sourceFields)
    {
        /// <summary>
