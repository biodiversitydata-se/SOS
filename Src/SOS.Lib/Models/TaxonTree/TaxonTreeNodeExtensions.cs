...
{
    extension<T>(IEnumerable<TaxonTreeNode<T>> treeNodes)
    {
        public IEnumerable<TaxonTreeNode<T>> AsDepthFirstNodeIterator(
        ...
        private IEnumerable<TaxonTreeNode<T>> AsDepthFirstNodeIterator(
        ...
        private IEnumerable<TaxonTreeNode<T>> AsUniqueDepthFirstNodeIterator(
            bool returnSelf = false)
        {
            var stack = new Stack<TaxonTreeNode<T>>();
    ...
    extension<T>(TaxonTreeNode<T> treeNode)
    {
        public IEnumerable<TaxonTreeNode<T>> AsDepthFirstNodeIterator(
        bool returnSelf = false,
        bool returnOnlyUniqueNodes = true)
        ...
        public IEnumerable<TaxonTreeNode<T>> AsParentsNodeIterator(
            bool returnSelf = false)
        {
            if (returnSelf) yield return treeNode;
        ...
        public HashSet<TaxonTreeEdge<T>> GetParentsEdges(
        ...
        public HashSet<TaxonTreeEdge<T>> GetChildEdges(
