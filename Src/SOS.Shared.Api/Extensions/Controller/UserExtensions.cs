...
namespace SOS.Shared.Api.Extensions.Controller
{
    public static class UserExtensions
    {
        ...
        /// </summary>
        public static int GetUserId(this ControllerBase controller) => int.Parse(controller?.User?.Claims?.FirstOrDefault(c => c.Type.Contains("http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier", StringComparison.CurrentCultureIgnoreCase))?.Value ?? "0");
