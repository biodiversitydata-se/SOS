        ...
        public static byte[] ToCsv(this IEnumerable<Contracts.Models.Event> events)
        {
            ...
            foreach (var evt in events)
            {
                csvFileHelper.WriteRow(new[] {
                    ...
                    evt.EventType,
                    evt.ParentEventID,
                    evt.EventStartDateTime.ToLongDateString(),
                    evt.EventEndDateTime.ToLongDateString(),
                    evt.EventStartDate.ToString("yyyy-MM-dd"),
                    evt.EventEndDate.ToString("yyyy-MM-dd"),
                    evt.EventStartTime?.ToString("HH:mm:ss"),
                    evt.EventEndTime?.ToString("HH:mm:ss"),
