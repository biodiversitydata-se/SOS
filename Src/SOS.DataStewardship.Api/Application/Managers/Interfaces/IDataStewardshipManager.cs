...
public interface IDataStewardshipManager
{
    ...
    Task<Contracts.Models.PagedResult<EventModel>> GetEventsBySearchAsync(EventsFilter filter, int skip, int take, CoordinateSystem responseCoordinateSystem, bool sortByDate = false);
