...
namespace SOS.Process.UnitTests.Processors
{
    ...
    public class KULObservationProcessorTests
    {
        ...
        private DataProvider CreateDataProvider()
        {
            ...
            {
                Names = new[] { new VocabularyValueTranslation { CultureCode = "en-GB", Value = "KUL" } },
        ...
        public async Task ProcessAsyncSuccess()
        {
            ...
            _processedPublicObservationRepository.Setup(r => r.DeleteProviderDataAsync(It.IsAny<DataProvider>()))
                .ReturnsAsync(true);
            _processedProtectedObservationRepository.Setup(r => r.DeleteProviderDataAsync(It.IsAny<DataProvider>()))
                .ReturnsAsync(true);
