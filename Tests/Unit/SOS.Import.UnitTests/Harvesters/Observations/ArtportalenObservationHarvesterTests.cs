...
namespace SOS.Import.UnitTests.Harvesters.Observations
{
    ...
    public class ArtportalenObservationHarvesterTests
    {
        ...
        public async Task AggregateAsyncSuccess()
        {
            ...
            _sightingRepositoryMock.Setup(sr => sr.GetIdSpanAsync(It.IsAny<bool>()))
                .ReturnsAsync((1, 1));
            _sightingRepositoryMock.Setup(sr => sr.GetChunkAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>()))
                .ReturnsAsync(
