namespace SOS.UserStatistics.Api.AutomaticIntegrationTests.Tests
{
    ...
    ///  - Test SortBy
    /// </summary>
    public class ProcessedObservationPagedSpeciesCountAggregationTests
    {
        private readonly UserStatisticsAutomaticIntegrationTestFixture _fixture;

        public ProcessedObservationPagedSpeciesCountAggregationTests(UserStatisticsAutomaticIntegrationTestFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task Test_PagedSpeciesCountAggregation()
        {
            ...
            // Act
            var res = await _fixture.UserStatisticsManager.ProcessedObservationPagedSpeciesCountSearchAsync(query, 0, 5);
        ...
        public async Task Test_PagedSpeciesCountAggregation_with_IncludeOtherAreasSpeciesCount()
        {
            ...
            // Act
            var res = await _fixture.UserStatisticsManager.ProcessedObservationPagedSpeciesCountSearchAsync(
                query,
                0,
                5);
        ...
        public async Task Test_PagedSpeciesCount_with_large_amount_of_data()
        {
            ...
            await _fixture.ProcessAndAddObservationsToElasticSearch(verbatimObservations.Union(verbatimObservations2));
            Thread.Sleep(5000);
            var query = new SpeciesCountUserStatisticsQuery();
