    ...
    public class CreateDwcDataStatisticsTool : TestBase
    {
        ...
        public async Task Harvest_all_dwca_files_in_specified_folder()
        {
            ...
            var harvestInfo = await dwcObservationHarvester.HarvestMultipleDwcaFilesAsync(
                filePaths,
                emptyCollectionsBeforeHarvest: true,
        ...
        {
            string filePath = @"c:\temp\DwcDataStatistics.xlsx";
            const int maxNrOfValues = 10000;
            string collectionName = nameof(DwcObservationVerbatim);
            ...
            foreach (var pair in DwcPropertyExpressionDictionary)
            {
                try
                {
                    var valueCountList = dwcRepository.GetDistinctValuesCount(collectionName, pair.Value, maxNrOfValues);
                    bool containValues = valueCountList.Any(m => !string.IsNullOrWhiteSpace(m.Value));
                    if (!containValues)
                    {
                    ...
                    // Add headers
                    ExcelWorksheet fieldWorksheet = package.Workbook.Worksheets.Add(pair.Key);
        ...
        private Dictionary<string, Expression<Func<DwcObservationVerbatim, DistinctValueObject<string>>>> DwcPropertyExpressionDictionary
        {
            get
            {
                return new Dictionary<string, Expression<Func<DwcObservationVerbatim, DistinctValueObject<string>>>>
                {
                    {"DataProviderIdentifier",observation => new DistinctValueObject<string>(observation.DataProviderIdentifier)},
                    ...
                    {"BibliographicCitation",observation => new DistinctValueObject<string>(observation.BibliographicCitation)},
                    ...
                    {"DataGeneralizations",observation => new DistinctValueObject<string>(observation.DataGeneralizations)},
                    ...
                    {"DynamicProperties",observation => new DistinctValueObject<string>(observation.DynamicProperties)},
                    {"InformationWithheld",observation => new DistinctValueObject<string>(observation.InformationWithheld)},
                    ...
                    {"OwnerInstitutionCode",observation => new DistinctValueObject<string>(observation.OwnerInstitutionCode)},
                    ...
                    {"VerbatimEventDate",observation => new DistinctValueObject<string>(observation.VerbatimEventDate)},
                    ...
                    {"EarliestAgeOrLowestStage",observation => new DistinctValueObject<string>(observation.EarliestAgeOrLowestStage)},
                    {"EarliestEonOrLowestEonothem",observation => new DistinctValueObject<string>(observation.EarliestEonOrLowestEonothem)},
                    {"EarliestEpochOrLowestSeries",observation => new DistinctValueObject<string>(observation.EarliestEpochOrLowestSeries)},
                    {"EarliestEraOrLowestErathem",observation => new DistinctValueObject<string>(observation.EarliestEraOrLowestErathem)},
                    {"EarliestGeochronologicalEra",observation => new DistinctValueObject<string>(observation.EarliestGeochronologicalEra)},
                    {"EarliestPeriodOrLowestSystem",observation => new DistinctValueObject<string>(observation.EarliestPeriodOrLowestSystem)},
                    {"Formation",observation => new DistinctValueObject<string>(observation.Formation)},
                    {"GeologicalContextID",observation => new DistinctValueObject<string>(observation.GeologicalContextID)},
                    {"Group",observation => new DistinctValueObject<string>(observation.Group)},
                    {"HighestBiostratigraphicZone",observation => new DistinctValueObject<string>(observation.HighestBiostratigraphicZone)},
                    {"LatestAgeOrHighestStage",observation => new DistinctValueObject<string>(observation.LatestAgeOrHighestStage)},
                    {"LatestEonOrHighestEonothem",observation => new DistinctValueObject<string>(observation.LatestEonOrHighestEonothem)},
                    {"LatestEpochOrHighestSeries",observation => new DistinctValueObject<string>(observation.LatestEpochOrHighestSeries)},
                    {"LatestEraOrHighestErathem",observation => new DistinctValueObject<string>(observation.LatestEraOrHighestErathem)},
                    {"LatestGeochronologicalEra",observation => new DistinctValueObject<string>(observation.LatestGeochronologicalEra)},
                    {"LatestPeriodOrHighestSystem",observation => new DistinctValueObject<string>(observation.LatestPeriodOrHighestSystem)},
                    {"LithostratigraphicTerms",observation => new DistinctValueObject<string>(observation.LithostratigraphicTerms)},
                    {"LowestBiostratigraphicZone",observation => new DistinctValueObject<string>(observation.LowestBiostratigraphicZone)},
                    ...
                    {"IdentificationQualifier",observation => new DistinctValueObject<string>(observation.IdentificationQualifier)},
                    {"IdentificationReferences",observation => new DistinctValueObject<string>(observation.IdentificationReferences)},
                    {"IdentificationRemarks",observation => new DistinctValueObject<string>(observation.IdentificationRemarks)},
                    {"IdentificationVerificationStatus",observation => new DistinctValueObject<string>(observation.IdentificationVerificationStatus)},
                    ...
                    {"CoordinatePrecision",observation => new DistinctValueObject<string>(observation.CoordinatePrecision)},
                    {"CoordinateUncertaintyInMeters",observation => new DistinctValueObject<string>(observation.CoordinateUncertaintyInMeters)},
                    ...
                    {"FootprintSpatialFit",observation => new DistinctValueObject<string>(observation.FootprintSpatialFit)},
                    ...
                    {"GeoreferencedDate",observation => new DistinctValueObject<string>(observation.GeoreferencedDate)},
                    {"GeoreferenceProtocol",observation => new DistinctValueObject<string>(observation.GeoreferenceProtocol)},
                    {"GeoreferenceRemarks",observation => new DistinctValueObject<string>(observation.GeoreferenceRemarks)},
                    {"GeoreferenceSources",observation => new DistinctValueObject<string>(observation.GeoreferenceSources)},
                    {"GeoreferenceVerificationStatus",observation => new DistinctValueObject<string>(observation.GeoreferenceVerificationStatus)},
                    {"HigherGeography",observation => new DistinctValueObject<string>(observation.HigherGeography)},
                    {"HigherGeographyID",observation => new DistinctValueObject<string>(observation.HigherGeographyID)},
                    ...
                    {"LocationAccordingTo",observation => new DistinctValueObject<string>(observation.LocationAccordingTo)},
                    ...
                    {"MaximumDepthInMeters",observation => new DistinctValueObject<string>(observation.MaximumDepthInMeters)},
                    {"MaximumDistanceAboveSurfaceInMeters",observation => new DistinctValueObject<string>(observation.MaximumDistanceAboveSurfaceInMeters)},
                    {"MaximumElevationInMeters",observation => new DistinctValueObject<string>(observation.MaximumElevationInMeters)},
                    {"MinimumDepthInMeters",observation => new DistinctValueObject<string>(observation.MinimumDepthInMeters)},
                    {"MinimumDistanceAboveSurfaceInMeters",observation => new DistinctValueObject<string>(observation.MinimumDistanceAboveSurfaceInMeters)},
                    {"MinimumElevationInMeters",observation => new DistinctValueObject<string>(observation.MinimumElevationInMeters)},
                    {"Municipality",observation => new DistinctValueObject<string>(observation.Municipality)},
                    {"PointRadiusSpatialFit",observation => new DistinctValueObject<string>(observation.PointRadiusSpatialFit)},
                    {"StateProvince",observation => new DistinctValueObject<string>(observation.StateProvince)},
                    {"VerbatimCoordinates",observation => new DistinctValueObject<string>(observation.VerbatimCoordinates)},
                    {"VerbatimCoordinateSystem",observation => new DistinctValueObject<string>(observation.VerbatimCoordinateSystem)},
                    {"VerbatimDepth",observation => new DistinctValueObject<string>(observation.VerbatimDepth)},
                    {"VerbatimElevation",observation => new DistinctValueObject<string>(observation.VerbatimElevation)},
                    ...
                    {"VerbatimLongitude",observation => new DistinctValueObject<string>(observation.VerbatimLongitude)},
                    ...
                    {"AssociatedReferences",observation => new DistinctValueObject<string>(observation.AssociatedReferences)},
                    {"AssociatedSequences",observation => new DistinctValueObject<string>(observation.AssociatedSequences)},
                    ...
                    {"EstablishmentMeans",observation => new DistinctValueObject<string>(observation.EstablishmentMeans)},
                    ...
                    {"OccurrenceRemarks",observation => new DistinctValueObject<string>(observation.OccurrenceRemarks)},
                    ...
                    {"OrganismQuantityType",observation => new DistinctValueObject<string>(observation.OrganismQuantityType)},
                    {"OtherCatalogNumbers",observation => new DistinctValueObject<string>(observation.OtherCatalogNumbers)},
                    ...
                    {"ReproductiveCondition",observation => new DistinctValueObject<string>(observation.ReproductiveCondition)},
                    ...
                    {"AssociatedOccurrences",observation => new DistinctValueObject<string>(observation.AssociatedOccurrences)},
                    {"AssociatedOrganisms",observation => new DistinctValueObject<string>(observation.AssociatedOrganisms)},
                    {"PreviousIdentifications",observation => new DistinctValueObject<string>(observation.PreviousIdentifications)},
                    {"OrganismRemarks",observation => new DistinctValueObject<string>(observation.OrganismRemarks)},
                    {"AcceptedNameUsage",observation => new DistinctValueObject<string>(observation.AcceptedNameUsage)},
                    {"AcceptedNameUsageID",observation => new DistinctValueObject<string>(observation.AcceptedNameUsageID)},
                    ...
                    {"HigherClassification",observation => new DistinctValueObject<string>(observation.HigherClassification)},
                    {"InfraspecificEpithet",observation => new DistinctValueObject<string>(observation.InfraspecificEpithet)},
                    ...
                    {"NameAccordingToID",observation => new DistinctValueObject<string>(observation.NameAccordingToID)},
                    {"NamePublishedIn",observation => new DistinctValueObject<string>(observation.NamePublishedIn)},
                    {"NamePublishedInID",observation => new DistinctValueObject<string>(observation.NamePublishedInID)},
                    {"NamePublishedInYear",observation => new DistinctValueObject<string>(observation.NamePublishedInYear)},
                    {"NomenclaturalCode",observation => new DistinctValueObject<string>(observation.NomenclaturalCode)},
                    {"NomenclaturalStatus",observation => new DistinctValueObject<string>(observation.NomenclaturalStatus)},
                    {"Order",observation => new DistinctValueObject<string>(observation.Order)},
                    {"OriginalNameUsage",observation => new DistinctValueObject<string>(observation.OriginalNameUsage)},
                    {"OriginalNameUsageID",observation => new DistinctValueObject<string>(observation.OriginalNameUsageID)},
                    {"ParentNameUsage",observation => new DistinctValueObject<string>(observation.ParentNameUsage)},
                    {"ParentNameUsageID",observation => new DistinctValueObject<string>(observation.ParentNameUsageID)},
                    ...
                    {"ScientificNameAuthorship",observation => new DistinctValueObject<string>(observation.ScientificNameAuthorship)},
                    ...
                    {"VerbatimTaxonRank",observation => new DistinctValueObject<string>(observation.VerbatimTaxonRank)},
                    {"VernacularName",observation => new DistinctValueObject<string>(observation.VernacularName)},
                    {"FromLithostratigraphicUnit",observation => new DistinctValueObject<string>(observation.FromLithostratigraphicUnit)},
