...
namespace SOS.Import.IntegrationTests.TestDataTools
{
    public class CreateDefaultDataProvidersTool : TestBase
    {
        ...
        public void CreateDefaultDataProvidersJsonFile()
        {
            ...
            var dataProviderByIdentifier = GetDataProviders().ToDictionary(dataProvider => dataProvider.Identifier, dataProvider => dataProvider);
        ...
        private List<DataProvider> GetDataProviders()
        {
            var dataProviders = new List<DataProvider>
            {
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "Musselportalen är ett öppet rapporteringssystem för stormusslor som förekommer i svenska sjöar och vatten­drag. Syftet är att öka kunskapen om stormusslor och innehållet i portalen kan användas för att följa tillståndet för de hotade och sällsynta musselarter­na i landet.",
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "Kustlaboratoriets databas KUL innehåller kvalitetssäkrade fångstdata av fisk. I basen lagras också stickprovsinformation som könsfördelning och uppgifter om enskilda fiskar som längd, vikt, ålder och likande. Databasen kompletterar Kustlaboratoriets interna provfiskedatabas FiRRe som lagrar fångstuppgifter som insamlats sedan 1960-talet. Ett kontinuerligt arbete pågår med att föra över äldre data till KUL. Administreras av Kustlaboratoriet, Institutionen för akvatiska resurser, SLU.",
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "MVM står för Mark, Vatten och Miljödata. De delar av databasen som utgörs av artobservationer är tillgängliga via Svenska LifeWatch. Här finns data om till exempel växtplankton, bottenfauna, makrofyter och kiselalger.",
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "Innehåller data från nätprovfiske i svenska sjöar. Administrerades tidigare av Fiskeriverket, numera av Institutionen för akvatiska resurser vid SLU.",
                ...
                new DataProvider
                {
                    ...
                    Organization = "Department of Aquatic Resources, SLU",
                    SwedishOrganization = "Institutionen för akvatiska resurser, SLU",
                    Description = "The database called SERS contains data from experimental fishing with electricity in Swedish rivers and streams.",
                    SwedishDescription = "Innehåller data från provfiske med elaggregat i svenska vattendrag. Administrerades tidigare av Fiskeriverket, numera av Institutionen för akvatiska resurser vid SLU.",
                ...
                new DataProvider
                {
                    ...
                    Description = "The six largest herbaria in Sweden are gathered in the Virtual Herbarium. Herbarium (GB) - Gothenburg, Botanical Museum (LD) - Lund, Biological Museum (OHN) - Oskarshamn, Swedish Museum of Natural History (S) - Stockholm, Herbarium (UME) - Umeå, Museum of Evolution (UPS) - Uppsala.",
                    SwedishDescription = "De sex största herbarierna i Sverige är samlade i Virtuella Herbariet. Herbarium (GB) - Göteborg, Botaniska Museet (LD) - Lund, Biologiska museet (OHN) - Oskarshamn, Naturhistoriska riksmuseet (S) - Stockholm, Herbarium (UME) - Umeå, Evolutionsmuseet (UPS) - Uppsala.",
                ...
                new DataProvider
                {
                    ...
                    Description = "(\"Svenskt HavsARKiv\" / \"Swedish Ocean Archive\") contains marine environmental monitoring data from the seas surrounding Sweden. Data from SHARK includes marine benthic fauna, marine benthic vegetation, plankton, and seal observations.",
                    SwedishDescription = "Innehåller marina miljöövervakningsdata från de hav som omger Sverige. Innehåller bland annat data från provtagning av mjukbottenfauna (zoobenthos), bottenvegetation (phytobenthos), djur-, växt- och bakterieplankton, samt förekomst av vikaresäl, gråsäl och knubbsäl. SHARK administreras av SMHI.",
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "Databasen innehåller uppgifter om fåglar ringmärkta i Sverige från 1911 och framåt (dock ej uppgifter om återfynd). Uppskattningsvis en tredjedel av Ringmärkningscentralens data är hittills digitaliserade.",
                    ContactPerson = "-",
                    ContactEmail = "-",
                ...
                new DataProvider
                {
                    ...
                    SwedishDescription = "Denna datamängd representerar digitala innehav av insekter, kvalster (kvalster och spindlar) och myriapods (tusenfotingar) vid Naturhistoriska riksmuseet. Dessa samlingar omfattar över tre miljoner exemplar, har internationella omfattning, och har en bred systematisk och geografisk täckning.",
                    ContactPerson = "-",
                    ContactEmail = "-",
                ...
                new DataProvider
                {
                    ...
                    Organization = "Swedish Museum of Natural History",
                    SwedishOrganization = "Naturhistoriska riksmuseet",
                    Description = "This data set contains observations of dead or alive harbor porpoises made by the public mostly around the Swedish coast. Each observation of harbor porpoises is verified at the Swedish Museum of Natural History before it is approved and published on the web. Swedish LifeWatch provides all georeferenced records from this data provider which relates to taxa in the Swedish Taxonomic Database (Dyntaxa) and that represents observations made in Sweden. The records are obtained via the web service at GBIF.org.",
                    SwedishDescription = "Databasen omfattar observationer av levande och döda tumlare som rapporterats till Naturhistoriska museet.",
                    ContactPerson = "-",
                    ContactEmail = "-",
