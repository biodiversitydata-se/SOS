        ...
        private List<DataProvider> GetDataProviders()
        {
            var dataProviders = new List<DataProvider>
            {
                ...
                new DataProvider
                {
                    ...
                    SwedishName = "SLU Riksskogstaxeringen: Förekomst- och icke förekomst. Vegetationsdata",
                    Organization = "Swedish National Forest Inventory, SLU",
                    SwedishOrganization = "SLU Riksskogstaxeringen",
