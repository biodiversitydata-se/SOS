...
namespace SOS.IntegrationTests.Tests.ApiEndpoints.ObservationsEndpoints.ObservationsBySearchInternalEndpoint;
...
public class ObservationPropertiesTest : TestBase
{
    ...
    public async Task GetObservationsWithOccurrenceRemarks()
    {
        ...
        await ProcessFixture.AddObservationsToElasticsearchAsync(new[] { observation }, false);
