...
public class CreateArtportalenJsonTestData : TestBase
{
    ...
    public CreateArtportalenJsonTestData(TestFixture testFixture, ITestOutputHelper output) : base(testFixture, output)
    {
    }
    ...
    public async Task CreateArtportalenVerbatimObservationTestData()
    {
        ...
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimObservations10000_1.json", strJson, Encoding.UTF8);
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimObservations1000_1.json", JsonSerializer.Serialize(verbatimObservations.Take(1000), serializeOptions), Encoding.UTF8);
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimObservations5000_1.json", JsonSerializer.Serialize(verbatimObservations.Take(5000), serializeOptions), Encoding.UTF8);
        ...
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimObservations1000_2.json", JsonSerializer.Serialize(verbatimObservations.Take(1000), serializeOptions), Encoding.UTF8);
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimObservations5000_2.json", JsonSerializer.Serialize(verbatimObservations.Take(5000), serializeOptions), Encoding.UTF8);
    ...
    public async Task CreateArtportalenVerbatimChecklistTestData()
    {
        ...
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimChecklists1000.json", strJson, Encoding.UTF8);

        var strJson2 = JsonSerializer.Serialize(verbatimChecklists, serializeOptions);
        File.WriteAllText(@"C:\Temp\ArtportalenVerbatimChecklists1000_2.json", strJson2, Encoding.UTF8);
    }
