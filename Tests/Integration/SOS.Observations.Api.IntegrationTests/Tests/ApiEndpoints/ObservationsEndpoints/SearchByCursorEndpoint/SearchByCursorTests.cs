...
namespace SOS.Observations.Api.IntegrationTests.Tests.ApiEndpoints.ObservationsEndpoints.SearchByCursorEndpoint;

/// <summary>
/// Integration tests for the SearchByCursor endpoint (deep pagination using Elasticsearch search_after).
/// </summary>
[Collection(TestCollection.Name)]
public class SearchByCursorTests : TestBase
{
    public SearchByCursorTests(TestFixture testFixture, ITestOutputHelper output) : base(testFixture, output)
    {
    }
