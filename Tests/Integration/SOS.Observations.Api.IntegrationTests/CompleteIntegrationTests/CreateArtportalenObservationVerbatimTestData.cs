...
namespace SOS.Observations.Api.IntegrationTests.CompleteIntegrationTests
{
    ...
    public class CreateArtportalenObservationVerbatimTestData
    {
        ...
        public async Task CreateArtportalenVerbatimObservationTestData()
        {
            ...
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations10000_1.json", strJson, Encoding.UTF8);
            
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations1000_1.json", Newtonsoft.Json.JsonConvert.SerializeObject(verbatimObservations.Take(1000), serializerSettings), Encoding.UTF8);
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations5000_1.json", Newtonsoft.Json.JsonConvert.SerializeObject(verbatimObservations.Take(5000), serializerSettings), Encoding.UTF8);
            ...
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations10000_2.json", strJson2, Encoding.UTF8);
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations1000_2.json", System.Text.Json.JsonSerializer.Serialize(verbatimObservations.Take(1000), jsonSerializerOptions), Encoding.UTF8);
            System.IO.File.WriteAllText(@"C:\Temp\2022-04-05\ArtportalenVerbatimObservations5000_2.json", System.Text.Json.JsonSerializer.Serialize(verbatimObservations.Take(5000), jsonSerializerOptions), Encoding.UTF8);
