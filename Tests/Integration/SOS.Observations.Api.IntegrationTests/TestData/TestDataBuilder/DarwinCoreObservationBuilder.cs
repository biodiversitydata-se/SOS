...
public static class DarwinCoreObservationBuilder
{
    ...
    extension(IOperable<DwcObservationVerbatim> operable)
    {
        public IOperable<DwcObservationVerbatim> HaveRandomValues()
        {
        ...
        public IOperable<DwcObservationVerbatim> HaveValuesFromPredefinedObservations()
        {
            var builder = ((IDeclaration<DwcObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<DwcObservationVerbatim> HaveSensitiveSpeciesTaxonId()
        {
            var builder = ((IDeclaration<DwcObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
