...
public static class ArtportalenObservationBuilder
{
    ...
    extension(IOperable<ArtportalenObservationVerbatim> operable)
    {
        public IOperable<ArtportalenObservationVerbatim> HaveRandomValues()
        {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveValuesFromPredefinedObservations(bool sensitive = false)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveRedlistedTaxonId(string? category)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveTaxonCategoryTaxonId(int categoryId)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveAreaFeatureIds(string provinceFeatureId,
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveCoordinatesInSpan(double longitudeMin,
           double longitudeMax,
           double latitudeMin,
           double latitudeMax,
           int accuracy)
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveCoordinates(double longitude,
           double latitude,
           int accuracy)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            ...
            builder.With((obs, index) =>
            {
                ...
                Point wgs84Point = new Point(longitude, latitude);
                var webMercatorPoint = wgs84Point.Transform(CoordinateSys.WGS84, CoordinateSys.WebMercator);
                obs.Site.XCoord = (int)webMercatorPoint!.Coordinate.X;
                obs.Site.YCoord = (int)webMercatorPoint.Coordinate.Y;
                obs.Site.Point = wgs84Point?.ToGeoJson();
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveCoordinatesInGeometry(Geometry geometry,
           int accuracy)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveCoordinatesOusideGeometry(Geometry geometry,
           int accuracy)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveProjectInformation(
    bool sensitive = false)
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveMediaInformation(
    bool sensitive = false)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
        ...
        public IOperable<ArtportalenObservationVerbatim> IsInDateSpan(DateTime spanStartDate, DateTime spanEndDate)
        {
        ...
        public IOperable<ArtportalenObservationVerbatim> WithStartDate(string strDate)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
        ...
        public IOperable<ArtportalenObservationVerbatim> WithEndDate(string strDate)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
        ...
        public IOperable<ArtportalenObservationVerbatim> WithStartEndDate(string strStartDate, string strEndDate)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
        ...
        public IOperable<ArtportalenObservationVerbatim> IsInDateSpan(string strSpanStartDate, string strSpanEndDate)
        {
        ...
        public IOperable<ArtportalenObservationVerbatim> IsDiffused(int diffusionId)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveTaxonSensitivityCategory(int sensitivityCategory)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveObserversWithId(params int[] userIds)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveProperties(params ObservationProperties[] properties)
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveProperties(int userId,
        ...
        public IOperable<ArtportalenObservationVerbatim> HaveUniqueUserId()
        {
            var builder = ((IDeclaration<ArtportalenObservationVerbatim>)operable).ObjectBuilder;
            builder.With((obs, index) =>
            {
