...
public class ProcessFixture : IProcessFixture
{
    ...
    public static ServiceCollection GetServiceCollection()
    {
        ...
        serviceCollection.AddSingleton<IClassCache<ConcurrentDictionary<string, CacheEntry<GeoGridResultDto>>>>(geoGridAggregationCache);
        ...
        serviceCollection.AddSingleton<IClassCache<ConcurrentDictionary<string, CacheEntry<PagedResultDto<TaxonAggregationItemDto>>>>>(taxonAggregationInternalCache);
    ...
    public List<Observation> ProcessObservations(IEnumerable<ArtportalenObservationVerbatim> verbatimObservations, bool enableDiffusion = false)
    {
        ...
        {
            var processedObservation = _artportalenObservationFactory!.CreateProcessedObservation(verbatimObservation, !enableDiffusion);
