...
namespace SOS.AutomaticIntegrationTests.IntegrationTests.ObservationApi.ObservationsController.GeoGridTaxaAggregationInternalEndpoint
{
    [Collection(Constants.IntegrationTestsCollectionName)]
    public class GeoGridTaxaAggregationTest
    {
        private readonly IntegrationTestFixture _fixture;

        public GeoGridTaxaAggregationTest(IntegrationTestFixture fixture)
        {
            _fixture = fixture;
        }
        [Fact]
        ...
        public async Task SumObservationCountInternalTest()
        {
            ...
            //-----------------------------------------------------------------------------------------------------------
            var response = await _fixture.ObservationsController.GeogridTaxaAggregationInternal(null, null, searchFilter);
