        ...
        public async Task GetObservationsWithActivityId()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
                .All()
                    .HaveValuesFromPredefinedObservations()
                .TheFirst(30)
                    .With(o => o.Activity = new Lib.Models.Shared.MetadataWithCategory(1, 2))
                .TheNext(30)
                    .With(o => o.Activity = new Lib.Models.Shared.MetadataWithCategory(2, 1))
                .TheNext(20)
                    .With(o => o.Activity = new Lib.Models.Shared.MetadataWithCategory(3, 1))
                .TheNext(20)
        ...
        public async Task GetObservationsWithBiotopeId()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
                .All()
                    .HaveValuesFromPredefinedObservations()
                .TheFirst(60)
                    .With(o => o.Biotope = new Lib.Models.Shared.MetadataWithCategory(1, 2))
                .TheNext(20)
                    .With(o => o.Biotope = new Lib.Models.Shared.MetadataWithCategory(2, 1))
                .TheNext(20)
        ...
        public async Task GetObservationsWithDiscoveryMethod()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
                .All()
                    .HaveValuesFromPredefinedObservations()
                .TheFirst(60)
                    .With(o => o.DiscoveryMethod = new Lib.Models.Shared.Metadata(1))
                .TheNext(20)
                    .With(o => o.DiscoveryMethod = new Lib.Models.Shared.Metadata(2))
                .TheNext(20)
        ...
        public async Task GetObservationsWithExcludeValidationStatusIds()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
                .All()
                    .HaveValuesFromPredefinedObservations()
                .TheFirst(20)
                    .With(o => o.ValidationStatus = new Lib.Models.Shared.Metadata(10))
                .TheNext(20)
                    .With(o => o.ValidationStatus = new Lib.Models.Shared.Metadata(20))
                .TheNext(30)
                    .With(o => o.ValidationStatus = new Lib.Models.Shared.Metadata(60))
                .TheNext(30)
        ...
        public async Task GetObservationsWithInstitutionId()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
               .All()
                   .HaveValuesFromPredefinedObservations()
               .TheFirst(60)
                   .With(o => o.OwnerOrganization = new Lib.Models.Shared.Metadata(1))
               .TheNext(20)
                   .With(o => o.OwnerOrganization = new Lib.Models.Shared.Metadata(2))
                .TheLast(20)
        ...
        public async Task GetObservationsWithLifeStageIds()
        {
            ...
            var verbatimObservations = Builder<ArtportalenObservationVerbatim>.CreateListOfSize(100)
               .All()
                   .HaveValuesFromPredefinedObservations()
               .TheFirst(60)
                   .With(o => o.Stage = new Lib.Models.Shared.Metadata(5))
                .TheLast(40)
                    .With(o => o.Stage = new Lib.Models.Shared.Metadata(0))
               .Build();
