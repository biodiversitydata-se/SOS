...
namespace SOS.AutomaticIntegrationTests.IntegrationTests.ObservationApi.UserStatisticsController
{
    ...
    public class ProcessedObservationPagedSpeciesCountAggregationTests
    {
        ...
        public ProcessedObservationPagedSpeciesCountAggregationTests(IntegrationTestFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task Test_PagedSpeciesCountAggregation()
        {
            ...
            // Act
            //-----------------------------------------------------------------------------------------------------------
            var response = await _fixture.UserStatisticsController.ProcessedObservationPagedSpeciesCountAggregation(query, 0,5);
        ...
        public async Task Test_PagedSpeciesCountAggregation_with_IncludeOtherAreasSpeciesCount()
        {
            ...
            // Act
            //-----------------------------------------------------------------------------------------------------------
            var response = await _fixture.UserStatisticsController.ProcessedObservationPagedSpeciesCountAggregation(
                query,
                0,
                5);
            var result = response.GetResultObject<PagedResultDto<UserStatisticsItem>>();
