...
### Search for species classified as invasive in Sweden
This filter will return observations of alien species classified as `Severe risk` or `High risk` regarding risk of invasiveness (according to Risk assessment list, listing alien species for which risk of invasiveness in Sweden has been assessed).
```json
{        
    "taxon" : {
...
| 13  |          | 44                        | Birds                                             | Fåglar                                        | Priority birds and Birds Directive species. [Birds Directive](https://environment.ec.europa.eu/topics/nature-and-biodiversity/birds-directive_en) aims to protect all naturally occurring wild bird species present in the EU and their most important habitats. [[information in Swedish]](https://www.artdatabanken.se/arter-och-natur/naturvard/skydd-av-arter/fageldirektivet/)                                                                                                                                                                                                                                                               |
...
| 20  | 6        | 40                        | Risk assessment - High impact                     | Risklista - Hög risk (HI)                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 27  | 7        | 230                       | Red listed species - Critically endangered (CR)   | Rödlista - Akut hotad (CR)                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
```
This filter will return observations where `observation.occurrence.isNotRediscoveredObservation=false` and `observation.occurrence.isNotRediscoveredObservation=true`. 
```json
{
